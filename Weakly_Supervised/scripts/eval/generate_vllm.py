...
def main(input_file, output_file, model_path, debug=False, remove_system=True, template='own', temperature=0.7, top_p=1.0, max_tokens=8192, n=1, force_generate=True, add_think_before_answer=False, add_oat_evaluate=False, any_true=False, skip_scoring=False, output_eval=None, no_split_think=False):
# def main(input_file, output_file, model_path, debug=False, remove_system=True, template='own', temperature=0.5, top_p=0.8, max_tokens=8192, n=1, force_generate=True, add_think_before_answer=False, add_oat_evaluate=False, any_true=False, skip_scoring=False, output_eval=None, no_split_think=False):
...
# def generate_vllm(messages, model_path, template='own', temperature=0.5, top_p=0.8, max_tokens=8192, n=1):
def generate_vllm(messages, model_path, template='own', temperature=1.0, top_p=0.95, max_tokens=8192, n=1):
    #vllm模型加载
