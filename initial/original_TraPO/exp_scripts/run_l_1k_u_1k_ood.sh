...
export EXP_NAME=labeled_1k_unlabeled_1k_ood
export WANDB_PROJECT="semi-grpo-outofdomain"
...
python3 -m verl.mix_src.main_mix_ppo \
    ...
    data.train_files=$DATA_DIR/ID_domain/openr1_1024_fixed.parquet \
    +data.unlabel_train_files=$DATA_DIR/OOD_domain/train.mmlu_pro-1024_fixed.parquet \
    data.val_files=$DATA_DIR/valid.parquet \
    data.train_batch_size=64 \
    +data.unlabel_train_batch_size=64 \
    ...
    +actor_rollout_ref.output_log_path=/ossfs/workspace/aitech_aidata/chuwei/code/TraPO/log/trapo_l_1k_u_1k_ood.log \
    +actor_rollout_ref.start_semi_epoch=10 \
